...
module.exports.handleReply = async function({ api, event, handleReply }) {
	...
	if (!permission.includes(event.senderID)) return api.sendMessage("You don't have permission to use this command only 𝙈𝙧𝙏𝙤𝙢𝙓𝙭𝙓", event.threadID, event.messageID);
