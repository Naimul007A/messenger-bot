...
module.exports.config = {
  ...
  version: "2.0.0",
  hasPermssion: 0,
  credits: "𝙈𝙧𝙏𝙤𝙢𝙓𝙭𝙓",//wag nyo change credits mga bwakanangshit
...
module.exports.run = async function ({ api, event, args, Users }) {
  if ((this.config.credits) != "𝙈𝙧𝙏𝙤𝙢𝙓𝙭𝙓") { return api.sendMessage(`Ulol change credits pa bobo`, event.threadID, event.messageID)}
