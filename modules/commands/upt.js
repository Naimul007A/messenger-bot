const fbname = "𝙍𝙖𝙩𝙪𝙡 𝙃𝙖𝙨𝙨𝙖𝙣";
const githubname = "𝙈𝙧𝙏𝙤𝙢𝙓𝙭𝙓";
...
let a = await loadImage(pathAva)
    ...
    ctx.fillStyle = "#000"
    ctx.fillText("AADI GUPTA", canvas.width / 2 - 660, 1000);
    ...
    ctx.fillStyle = "#000"
    ctx.fillText("𝙈𝙧𝙏𝙤𝙢𝙓𝙭𝙓" , 1200, 2750);
    ctx.fillStyle = "#FFF"
    ctx.fillText("𝙈𝙧𝙏𝙤𝙢𝙓𝙭𝙓", 1600, 3150);
    ctx.fillStyle = "#000"
   ctx.fillText("𝙈𝙧𝙏𝙤𝙢𝙓𝙭𝙓" , 2000, 3600);
    ctx.beginPath();
