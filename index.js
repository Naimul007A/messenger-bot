...
monitor.on('up', (res) => console.log(chalk.bold.hex("#00FF00")("[ MrTomXxX ] ❯ ") + chalk.hex("#00FF00")(`${res.website}`)))
...
axios.get("https://raw.githubusercontent.com/MrT0mXxX/MrT0m/main/package.json").then((res) => {
