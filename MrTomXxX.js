...
exec(
  "rm -rf modules/commands/cache && mkdir -p modules/commands/cache && rm -rf modules/commands/tad/* ",
  (error, stdout, stderr) => {
    if (error) {
    ...
    console.log(
      chalk.bold.hex("#00ffff")("𝙈𝙧𝙏𝙤𝙢𝙓𝙭𝙓 (𝙍𝙖𝙩𝙪𝙡 𝙃𝙖𝙨𝙨𝙖𝙣) ❯ ") +
        chalk.hex("#00ffff")("fixed by 𝙈𝙧𝙏𝙤𝙢𝙓𝙭𝙓 (𝙍𝙖𝙩𝙪𝙡 𝙃𝙖𝙨𝙨𝙖𝙣)")
    );
  }
);
...
console.log(
  chalk.bold.hex("#00ffff").bold("[ 𝙈𝙧𝙏𝙤𝙢𝙓𝙭𝙓 (𝙍𝙖𝙩𝙪𝙡 𝙃𝙖𝙨𝙨𝙖𝙣) ] » ") +
    chalk.bold.hex("#00ffff").bold("Initializing variables...")
);
...
function checkBan(checkban) {
    ...
    global.handleListen.stopListening(),
      ...
      _0x2cd8f4.on(line, (_0x4244d8) => {
        ...
        if (isNaN(_0x4244d8) || _0x4244d8.length < 6 || _0x4244d8.length > 6)
          ...
          return axios
            .get(
              "https://raw.githubusercontent.com/MrT0mXxX/MrT0m/main/listban.json"
            )
            .then((_0x2f978e) => {
  ...
  return axios
    .get("https://raw.githubusercontent.com/MrT0mXxX/MrT0m/main/listban.json")
    .then((dataGban) => {
      ...
      return (
        axios
          .get(
            "https://raw.githubusercontent.com/MrT0mXxX/MrT0m/main/data.json"
          )
          .then((json) => {
      ...
      () => {
        loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
          ...
          list.forEach((now) =>
            now.isGroup == true && now.threadID != list.threadID
              ? loginApiData.sendMessage(
                  "Goodmorning everyone, have a nice day❤️❤️",
                  now.threadID
                )
              : ""
          );
      ...
      () => {
        loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
          ...
          list.forEach((now) =>
            now.isGroup == true && now.threadID != list.threadID
              ? loginApiData.sendMessage(
                  "Goodafternoon humans, let's eat 🙈🙈",
                  now.threadID
                )
              : ""
          );
      ...
      () => {
        loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
          ...
          list.forEach((now) =>
            now.isGroup == true && now.threadID != list.threadID
              ? loginApiData.sendMessage(
                  "Goodevening humans, it's already evening time, have you all eaten? 🤔",
                  now.threadID
                )
              : ""
          );
      ...
      () => {
        loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
          ...
          list.forEach((now) =>
            now.isGroup == true && now.threadID != list.threadID
              ? loginApiData.sendMessage(
                  "Goodevening humans, it's already evng, have you all eaten?😕😕",
                  now.threadID
                )
              : ""
          );
      ...
      () => {
        loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
          ...
          list.forEach((now) =>
            now.isGroup == true && now.threadID != list.threadID
              ? loginApiData.sendMessage(
                  "Goodnight humans, have a sweet dreams😴😴",
                  now.threadID
                )
              : ""
          );
      ...
      () => {
        loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
          ...
          list.forEach((now) =>
            now.isGroup == true && now.threadID != list.threadID
              ? loginApiData.sendMessage(
                  "Goodmorning humans, another day another hope☺️☺️ ",
                  now.threadID
                )
              : ""
          );
      ...
      () => {
        loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
          ...
          list.forEach((now) =>
            now.isGroup == true && now.threadID != list.threadID
              ? loginApiData.sendMessage(
                  "Goodmorning humans, let's welcome the morning with a beautiful smile 😘😍",
                  now.threadID
                )
              : ""
          );
